...
function App() {
  return (
    <Container fluid="lg,sm,sx,md">
      <Navbar className="bg-info" expand="lg">
        <Navbar.Brand href="#home">YBUCK BLOG</Navbar.Brand>
      ...
      <Carousel>
        <Carousel.Item interval={1000}>
          <img
            ...
            src="https://as1.ftcdn.net/v2/jpg/02/15/84/20/500_F_215842088_udrMisz9cyj3OscJSZXth2aKsVm64zco.jpg"
            alt="First slide"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item interval={500}>
          <img
            className="d-block w-100"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEHJOMu2GCLvXPWvSwupoo1LnUhViK3QeziSIoPKg5VdIDHRDDLr_E34aaU65_3e-l-SE&usqp=CAU"
            alt="Second slide"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="https://sheptytskyinstitute.ca/wp-content/uploads/2018/08/masi-bookstore-banner-768x267.jpg"
            alt="Third slide"
          />
          {/* slider */}
          <Carousel.Caption>
      ...
      <Row className="cont">
        <Col>
          <center>
            <Button>Read A Book Today</Button>
          </center>
        </Col>
      </Row>
      ...
      <Row>
        <Image
          src="https://www.edtnaerca.org/resource/edtna/files/2020-el-library-main-banner.jpg"
          fluid
        />
      </Row>
      <Row className="section p-5, m-10">
        <Col className="section1 col-lg-6 col-md-8 col-md-offset-2 col-sm-12 p-5 m-6 m-offset-10" style={{ bg: "gray" }}>
        ...
        <Col className="section2 col-lg-6 col-md-8 col-sm-12" style={{ bg: "black" }}>
      ...
      <Row className="footer bg-secondary">
        <Col>
          <div>
            Follow us on{" "}
            <a>
      ...
      <Row className='bg-info'>
        <p>
          <center>Powered By <a href="/">Codehouze</a></center>
        </p>
      </Row>
    </Container>
    // <div className="App">
    //   <div className='row' stlye={}>
